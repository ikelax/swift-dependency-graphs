...
@Suite("If the vertex is not in the graph,") struct VertexNotInGraphTests {
  ...
  @Test("neighbour lookup returns nil for forwards direction") func forwards() {
    #expect(graph.neighbours(of: vertexNotInGraph, in: .forwards) == nil)
  }

  @Test("neighbour lookup returns nil for backwards direction") func backwards() {
    #expect(graph.neighbours(of: vertexNotInGraph, in: .backwards) == nil)
  }

  @Test("neighbour lookup returns nil for both directions") func both() {
...
@Suite("If the vertex is in the graph,") struct VertexInGraphTests {
  ...
  @Test("neighbour lookup returns its neighbours for forwards direction") func forwards() {
    #expect(graph.neighbours(of: vertex2, in: .forwards) == [vertex4, vertex5])
  }

  @Test("neighbour lookup returns its neighbours for backwards direction") func backwards() {
    #expect(graph.neighbours(of: vertex2, in: .backwards) == [vertex1])
  }

  @Test("neighbour lookup returns its neighbours for both directions") func both() {
...
@Suite("If the vertex has no neighbours") struct VertexHasNoNeighboursTests {
  ...
  @Suite("in forwards direction,") struct NoNeighboursInForwardsDirectionTests {
    ...
    @Test("neighbour lookup returns an empty set for forwards direction") func forwards() {
      #expect(graph.neighbours(of: vertex6, in: .forwards) == [])
    }

    @Test("neighbour lookup returns the neighbours for backwards direction") func backwards() {
      #expect(graph.neighbours(of: vertex6, in: .backwards) == [vertex3])
    }

    @Test("neighbour lookup returns the neighbours in backwards direction for both directions") func both() {
  ...
  @Suite("in backwards direction,") struct NoNeighboursInBackwardsDirectionTests {
    ...
    @Test("neighbour lookup returns the neighbours for forwards direction") func forwards() {
      #expect(graph.neighbours(of: vertex1, in: .forwards) == [vertex2, vertex3])
    }

    @Test("neighbour lookup returns an empty set for backwards direction") func backwards() {
      #expect(graph.neighbours(of: vertex1, in: .backwards) == [])
    }

    @Test("neighbour lookup returns the neighbours in forwards direction for both directions") func both() {
  ...
  @Suite("in both directions,") struct NoNeighboursInBothDirectionsTests {
    ...
    @Test("neighbour lookup returns an empty set for both directions") func both() {
